...
using HairSalon.Models; // so the application understands what we mean by <BestRestaurantsContext>
...
namespace HairSalon
{
  ...
  {
    public static string ConnectionString = "server=localhost;user id=root;password=epicodus;port=3306;database=tyler_bates;";
  }
}